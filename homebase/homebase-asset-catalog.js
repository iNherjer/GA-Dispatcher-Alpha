(function publishHomebaseAssetCatalog(root, factory) {
  ...
  const navigationFootprints = Object.freeze({
    ...
    'VFR Multitool Homebase Office Container': { widthM: 6.06, depthM: 2.44 },
    ...
    'VFR Multitool Homebase MX Pavilion': { widthM: 3.054, depthM: 3.054 },
  ...
  const withNavigationFootprint = entry => {
  ...
  return Object.freeze({
    ...
    assets: Object.freeze([
      ...
      { key: 'officeContainer', folder: 'VFRHomebaseOfficeContainer', title: 'VFR Multitool Homebase Office Container', kind: 'object', group: 'Gebäude', label: 'Bürocontainer', icon: 'B', version: '1.0.0', headingCorrectionDeg: 0, homebasePlaceable: true, workbenchVisible: true, footprint: { widthM: 6.06, depthM: 2.44 }, controls: [{ schemaVersion: 1, id: 'door', type: 'animation', label: 'Bürocontainertür', transport: 'simconnect-lvar', simvar: 'L:1:VFR_HOMEBASE_OFFICE_CONTAINER_DOOR_COMMAND', unit: 'number', scope: 'simobject', defaultState: 'open', durationMs: 4000, states: [{ id: 'open', label: 'Öffnen', value: 0 }, { id: 'closed', label: 'Schließen', value: 1 }] }, { schemaVersion: 1, id: 'interiorLight', type: 'light', label: 'Innenlicht', transport: 'simconnect-lvar', simvar: 'L:1:VFR_HOMEBASE_OFFICE_CONTAINER_LIGHT_COMMAND', unit: 'number', scope: 'simobject', defaultState: 'on', durationMs: 0, states: [{ id: 'on', label: 'Einschalten', value: 0 }, { id: 'off', label: 'Ausschalten', value: 1 }] }], animation: { schemaVersion: 1, type: 'door', durationMs: 4000, defaultState: 'open', control: { transport: 'simconnect-lvar', simvar: 'L:1:VFR_HOMEBASE_OFFICE_CONTAINER_DOOR_COMMAND', unit: 'number', scope: 'simobject', values: { open: 0, closed: 1 } } } },
