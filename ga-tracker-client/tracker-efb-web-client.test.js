...
test('tracker-hosted EFB page uses the original Kartentisch DOM and shared app modules', () => {
  ...
  assert.equal(EFB_WEB_ASSET_REVISION, '43101');
  assert.match(page, /data-efb-view-version="9"/);
  assert.match(page, /app-styles\.css\?v=43101/);
  assert.match(page, /host\.css\?v=43101/);
  assert.match(page, /map-shell-core\.js\?v=43101/);
  assert.match(page, /map-utility-tools\.js\?v=43101/);
  assert.match(page, /mission-control-ui-core\.js\?v=43101/);
  assert.match(page, /cockpit-session-client\.js\?v=43101/);
  assert.match(page, /host\.js\?v=43101/);
  ...
  assert.match(page, /src="\/efb\/v1\/assets\/map-utility-tools\.js\?v=43101"/);
  assert.match(page, /src="\/efb\/v1\/assets\/mission-control-ui-core\.js\?v=43101"/);
  assert.match(page, /src="\/efb\/v1\/assets\/cockpit-session-client\.js\?v=43101"/);
  assert.match(page, /src="\/efb\/v1\/assets\/host\.js\?v=43101"/);
  ...
  const scriptOrder = [
    ...
    '/efb/v1/assets/map-shell-core.js?v=43101',
    '/efb/v1/assets/map-utility-tools.js?v=43101',
    '/efb/v1/assets/mission-control-ui-core.js?v=43101',
    '/efb/v1/assets/cockpit-session-client.js?v=43101',
    '/efb/v1/assets/host.js?v=43101'
