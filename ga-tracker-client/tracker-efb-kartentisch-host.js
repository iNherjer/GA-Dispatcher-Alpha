(function () {
  ...
  function renderMissionToolbar(payload) {
    ...
    ['poi_status', 'poi_orientation', 'pax_wellbeing', 'pax_cargo', 'pax_weather', 'poi_tell_more'].forEach(function(intent, index) {
      ...
      if (!button && primaryButton && primaryButton.parentNode) {
        ...
        button.textContent = ['Missionsstatus','Orientierung','Wohlbefinden','Ladung','Wetter','Erzähl mal'][index];
