...
test('tracker v353 exits a duplicate instance when the fixed EFB port is already occupied', () => {
  assert.match(trackerSource, /const TRACKER_VERSION = 'v353'/);
  ...
  assert.match(trackerSource, /const TRACKER_VERSION_CODE = 353/);
