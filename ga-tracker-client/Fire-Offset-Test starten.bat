...
set "APP_URL=https://inherjer.github.io/GA-Dispatcher-Alpha/?swBypass=1^&fireDebug=1^&fireTruth=fire^&fireExtent=major_fire^&fireSpawnMode=target^&fireTest=offset_ladder^&fireCount=1^&fireRadius=0^&testBuild=fire-offset-v3"
