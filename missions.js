...
function generateDynamicPOIMission(poiName, maxSeats, forcedCategory = null) {
    ...
    const paxVIP = `1 PAX (VIP-Gast)`;
    const paxMedia = `1 PAX (Filmcrew)`;
    const paxSightseeing = `1 PAX (Sightseeing-Gast)`;
    ...
    if (poiCat === "bridge" || normalizedName.includes("bruecke") || normalizedName.includes("brucke") || normalizedName.includes("bridge") || normalizedName.includes("viadukt") || normalizedName.includes("aquadukt") || normalizedName.includes("steg") || normalizedName.includes("pont") || normalizedName.includes("puente")) {
        ...
        templates = [
            ...
            { i: "🥂", t: `Hochzeits-Überraschung: ${poiName}`, s: `Ein Gast plant eine besondere Hochzeitsüberraschung und möchte ${poiName} vorab von seiner romantischsten Seite sehen.`, p: paxVIP, w: cargoVIP },
        ...
        templates = [
            ...
            { i: "🧗", t: `Extremsport-Support: ${poiName}`, s: `Ein Extremsportler plant einen anspruchsvollen Stunt bei ${poiName}. Ein Teamvertreter muss das Terrain vorher aus der Luft genau studieren.`, p: paxMedia, w: cargoMedia },
        ...
        templates = [
            { i: "🏙️", t: `City-Panorama: ${poiName}`, s: `Ein Besuchsgast hat eine besondere Städtetour gebucht. Das Highlight der Route ist ganz klar ${poiName}.`, p: paxSightseeing, w: cargoVIP },
            ...
            { i: "🎆", t: `Event-Vorbereitung: ${poiName}`, s: `Ein großes Event steht an. Ein Sicherheitskoordinator soll das Gelände rund um ${poiName} aus der Luft begutachten, um Fluchtwege zu planen.`, p: "1 PAX (Security-Koordination)", w: "Pläne & Laptop (18 lbs)" },
        ...
        templates = [
            { i: "✈️", t: `Panoramaflug: ${poiName}`, s: `Ein klassischer Ausflugsflug zum Zielort: ${poiName}. Der Fluggast freut sich auf einen ruhigen Flug und tolle Ausblicke!`, p: paxSightseeing, w: "Tagesrucksack (12 lbs)" },
            ...
            { i: "🎁", t: `Überraschungsflug: ${poiName}`, s: `Jemand hat diesen Flug nach ${poiName} zum Geburtstag geschenkt bekommen. Mache es zu einem unvergesslichen Erlebnis!`, p: paxSightseeing, w: cargoVIP },
