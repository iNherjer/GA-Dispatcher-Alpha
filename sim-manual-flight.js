...
(function () {
    ...
    function _flightDataSnapshot(gsOverride = null) {
        ...
        return {
            ...
            iasKts: Math.max(0, Math.round(gs * 10) / 10),
            ias: Math.max(0, Math.round(gs * 10) / 10),
            pitchDeg: manual.onGround ? 0 : Math.max(-8, Math.min(12, Math.round(((manual.vsFpm || 0) / 500) * 10) / 10)),
