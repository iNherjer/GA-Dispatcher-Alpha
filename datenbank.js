...
// Legacy coreDB bewusst deaktiviert:
// Flughäfen sollen ausschließlich aus aktuellen Quellen (airports.json/OpenAIP) kommen.
Object.keys(coreDB).forEach(k => delete coreDB[k]);
...
const fallbackPOIs = [
    ...
    { n: "Rheinbrücke Kehl-Straßburg", lat: 48.576, lon: 7.814 },
    { n: "Köhlbrandbrücke Hamburg", lat: 53.530, lon: 9.952 },
    { n: "Viadukt von Millau", lat: 44.077, lon: 3.022 },
