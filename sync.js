...
const FIRE_DEBUG_SYNC_BUILD = 'scene-debug-20260520-5';
...
function _handleTrackerAck(ack) {
    ...
    if (ack.type === 'mission_scene_spawn_ack' || ack.type === 'mission_scene_clear_ack' || ack.type === 'mission_scene_boarding_ack') {
