...
| `boarding_pax` | Passagier steigt ein, Gurtzeug, Schritte, Tuer | Parallel zur Boarding-Geschichte; Passenger load/unload fallback | `audio-cues/boarding-pax.mp3` | `boarding-pax1.mp3` ... `boarding-pax8.mp3` |
| `boarding_cargo` | Mehrere Frachtteile werden eingeladen | Auto-load / groesserer Ladeprozess | `audio-cues/boarding-cargo.mp3` | `boarding-cargo1.mp3` ... `boarding-cargo8.mp3` |
| `cargo_load` | Einzelnes Cargo-Item wird geladen | Cargo Load Button, Wiederladen | `audio-cues/cargo-load.mp3` | `cargo-load1.mp3` ... `cargo-load8.mp3` |
| `cargo_unload` | Einzelnes Cargo-Item wird entladen | Cargo Unload Button | `audio-cues/cargo-unload.mp3` | `cargo-unload1.mp3` ... `cargo-unload8.mp3` |
| `cargo_pickup` | Pickup-Fracht wird am Ziel aufgenommen | Pickup-Cargo am Zielstrip/Zielplatz | `audio-cues/cargo-pickup.mp3` | `cargo-pickup1.mp3` ... `cargo-pickup8.mp3` |
| `cargo_drop` | Abwurf / harter Drop | Cargo im Flug abgeworfen | `audio-cues/cargo-drop.mp3` | `cargo-drop1.mp3` ... `cargo-drop8.mp3` |
