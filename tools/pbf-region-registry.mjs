...
export const REGIONS = [
  ...
  { id: 'de-bw', name: 'Baden-Württemberg',        bbox: [47.53,  7.51, 49.80, 10.50], sizeMb:  500, url: `${BASE}/germany/baden-wuerttemberg-latest.osm.pbf` },
  { id: 'de-by', name: 'Bayern',                   bbox: [47.27,  8.98, 50.57, 13.84], sizeMb: 1200, url: `${BASE}/germany/bavaria-latest.osm.pbf` },
  { id: 'de-be', name: 'Berlin',                   bbox: [52.34, 13.09, 52.68, 13.76], sizeMb:   25, url: `${BASE}/germany/berlin-latest.osm.pbf` },
  { id: 'de-bb', name: 'Brandenburg',              bbox: [51.36, 11.27, 53.56, 14.77], sizeMb:  130, url: `${BASE}/germany/brandenburg-latest.osm.pbf` },
  { id: 'de-hb', name: 'Bremen',                   bbox: [52.85,  8.48, 53.61,  9.01], sizeMb:    7, url: `${BASE}/germany/bremen-latest.osm.pbf` },
  { id: 'de-hh', name: 'Hamburg',                  bbox: [53.40,  8.42, 53.96, 10.33], sizeMb:   20, url: `${BASE}/germany/hamburg-latest.osm.pbf` },
  { id: 'de-he', name: 'Hessen',                   bbox: [49.39,  7.77, 51.66, 10.24], sizeMb:  200, url: `${BASE}/germany/hessen-latest.osm.pbf` },
  { id: 'de-mv', name: 'Mecklenburg-Vorpommern',   bbox: [53.11, 10.59, 54.69, 14.41], sizeMb:  100, url: `${BASE}/germany/mecklenburg-vorpommern-latest.osm.pbf` },
  { id: 'de-ni', name: 'Niedersachsen',            bbox: [51.29,  6.65, 53.90, 11.60], sizeMb:  400, url: `${BASE}/germany/niedersachsen-latest.osm.pbf` },
  { id: 'de-nw', name: 'Nordrhein-Westfalen',      bbox: [50.32,  5.86, 52.53,  9.46], sizeMb:  700, url: `${BASE}/germany/nordrhein-westfalen-latest.osm.pbf` },
  { id: 'de-rp', name: 'Rheinland-Pfalz',          bbox: [48.97,  6.11, 50.94,  8.51], sizeMb:  200, url: `${BASE}/germany/rheinland-pfalz-latest.osm.pbf` },
  { id: 'de-sl', name: 'Saarland',                 bbox: [49.11,  6.36, 49.64,  7.40], sizeMb:   25, url: `${BASE}/germany/saarland-latest.osm.pbf` },
  { id: 'de-sn', name: 'Sachsen',                  bbox: [50.17, 11.87, 51.68, 15.04], sizeMb:  200, url: `${BASE}/germany/sachsen-latest.osm.pbf` },
  { id: 'de-st', name: 'Sachsen-Anhalt',           bbox: [51.04, 10.56, 53.04, 13.19], sizeMb:  130, url: `${BASE}/germany/sachsen-anhalt-latest.osm.pbf` },
  { id: 'de-sh', name: 'Schleswig-Holstein',       bbox: [53.36,  7.87, 55.06, 11.31], sizeMb:  120, url: `${BASE}/germany/schleswig-holstein-latest.osm.pbf` },
  { id: 'de-th', name: 'Thüringen',                bbox: [50.20,  9.86, 51.65, 12.65], sizeMb:  130, url: `${BASE}/germany/thueringen-latest.osm.pbf` },
