...
assert.match(tracker, /TRACKER_VERSION = 'v288'/);
assert.match(tracker, /HOMEBASE_ENABLED = true/);
assert.match(sync, /MIN_TRACKER_VERSION_CODE = 288/);
...
assert.match(serviceWorker, /ga-dispatcher-v1464/);
assert.match(app, /sw\.js\?v=ga-dispatcher-v1464/);
