...
assert.match(worker, /const CACHE = 'ga-dispatcher-v1621'/);
assert.match(app, /sw\.js\?v=ga-dispatcher-v1621/);
...
console.log('Local-App-Cache-Selftest: OK (v1621, private local hosts run without Service Worker).');
